...
import 'package:khanashana/model/recipe_model.dart';
import 'package:khanashana/views/recipe_view.dart';
      ...
      body: Stack(
        children: <Widget>[
          ...
          SingleChildScrollView(
            child: Container(
              padding: EdgeInsets.symmetric(vertical: !kIsWeb ? Platform.isIOS? 60: 60 : 30, horizontal: 24),
              child: Column(
                        ...
                        InkWell(
                            onTap: () async {
                              if (textEditingController.text.isNotEmpty) {
                                ...
                                recipies = new List();
                                String url =
                                    "https://api.edamam.com/search?q=${textEditingController.text}&app_id=aab89b80&app_key=444c8e65c84e75c2e174d35bbcfd56e4";
                        ...
                        children: List.generate(recipies.length, (index) {
                          return GridTile(
                              child: RecipieTile(
                                ...
                                imgUrl: recipies[index].img,
                                desc: recipies[index].src,
